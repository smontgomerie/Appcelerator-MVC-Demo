...
// in simulator we redefine to format for MVCDemo Developer console
...
{\
	NSString * exceptionName = [@"org.mvcdemo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mvcdemo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMVCDemoNativeItemNone = -1, 
	UIMVCDemoNativeItemSpinner = -2,
	UIMVCDemoNativeItemProgressBar = -3,
	
	UIMVCDemoNativeItemSlider = -4,
	UIMVCDemoNativeItemSwitch = -5,
	UIMVCDemoNativeItemMultiButton = -6,
	UIMVCDemoNativeItemSegmented = -7,
	
	UIMVCDemoNativeItemTextView = -8,
	UIMVCDemoNativeItemTextField = -9,
	UIMVCDemoNativeItemSearchBar = -10,
	
	UIMVCDemoNativeItemPicker = -11,
	UIMVCDemoNativeItemDatePicker = -12,
	
	UIMVCDemoNativeItemInfoLight = -13,
	UIMVCDemoNativeItemInfoDark = -14,
	
	UIMVCDemoNativeItemDisclosure = -15,
	
	UIMVCDemoNativeItemContactAdd = -16
};
